Extension to https://github.com/rafagarciac/DotNETesting project to demonstrate automation of SpecFlow testing driving OpenCover and its ReportGenerator.
